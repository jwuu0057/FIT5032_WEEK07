...
namespace FIT5032_WEEK07.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [Authorize]
        public ActionResult Create([Bind(Include = "Id,FisrtName,LastName")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FisrtName,LastName,UserId")] Student student)
        {
            if (ModelState.IsValid)
            {
